...
describe(__filename, function () {
  it('postToolbarInit no longer forces background-color: transparent (#9)', async function () {
  ...
  it('postToolbarInit uses a CSS media query for dark-mode support (#dark-mode)',
      async function () {
        const src = fs.readFileSync(indexPath, 'utf8');
